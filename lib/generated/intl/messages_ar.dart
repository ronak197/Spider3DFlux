...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(time) => "تنتهي الصلاحية في ${time}";

  static String m5(hour) => "${hour} ساعات ماضية";

  static String m6(message) =>
      "حدثت مشكلة في التطبيق أثناء طلب البيانات ، يرجى الاتصال بالمسؤول لإصلاح المشكلة: ${message}";

  static String m7(size) => "أقصى حجم للملف: ${size} ميغابايت";

  static String m8(minute) => "${minute} دقائق ماضية";

  static String m9(itemCount) => "${itemCount} عنصر";

  static String m10(price) => "إجمالي الخيارات: ${price}";

  static String m11(percent) => "بيع ${percent} ٪";

  static String m12(second) => "${second} ثواني ماضية";
  ...
  static String m15(total) => "${total} من المنتجات";

  static String m16(date) => "صالح حتى ${date}";

  static String m17(message) => "تحذير: ${message}";

  static String m18(length) => "وجدنا منتجات ${length}";

  static String m19(week) => "الأسبوع ${week}";
