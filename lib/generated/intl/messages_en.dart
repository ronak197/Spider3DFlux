...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(time) => "Expiring in ${time}";
  ...
  static String m7(size) => "Maximum file size: ${size} MB";

  static String m8(minute) => "${minute} minutes ago";

  static String m9(itemCount) => "${itemCount} items";

  static String m10(price) => "Options total: ${price}";

  static String m11(percent) => "Sale ${percent}%";
  ...
  static String m15(total) => "${total} products";

  static String m16(date) => "Valid til ${date}";

  static String m17(message) => "Warning: ${message}";

  static String m18(length) => "We found ${length} products";

  static String m19(week) => "Week ${week}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "searchOrderId":
            MessageLookupByLibrary.simpleMessage("Search Order ID..."),
