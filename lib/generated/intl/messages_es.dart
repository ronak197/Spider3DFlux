...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(time) => "Caduca en ${time}";

  static String m5(hour) => "${hour}  horas";
  ...
  static String m7(size) => "Tamaño máximo de archivo: ${size} MB";

  static String m8(minute) => "${minute} minutos";

  static String m9(itemCount) => "${itemCount} items";

  static String m10(price) => "Total de opciones: ${price}";

  static String m11(percent) => "Rebaja ${percent} %";

  static String m12(second) => "${second} segundos";
  ...
  static String m15(total) => "${total} Productos";

  static String m16(date) => "Válido hasta ${date}";

  static String m17(message) => "Advertencia: ${message}";

  static String m18(length) => "Encontramos productos de ${length}";

  static String m19(week) => "Semana ${week}";
