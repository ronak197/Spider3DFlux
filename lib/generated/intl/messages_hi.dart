...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => " ${timeLeft}में समाप्त होता है";

  static String m3(message) => "त्रुटि: ${message}";

  static String m4(time) => " ${time}में समाप्त हो रहा है";

  static String m5(hour) => "${hour} घंटे पहले";
  ...
  static String m7(size) => "अधिकतम फ़ाइल आकार: ${size} एमबी";

  static String m8(minute) => "${minute} मिनट पहले";

  static String m9(itemCount) => "${itemCount} आइटम";

  static String m10(price) => "विकल्प कुल: ${price}";

  static String m11(percent) => "बिक्री ${percent} %";

  static String m12(second) => "${second} सेकंड पहले";

  static String m13(totalCartQuantity) =>
      "शॉपिंग कार्ट, ${totalCartQuantity} आइटम";

  static String m14(numberOfUnitsSold) => "बिक गया: ${numberOfUnitsSold}";

  static String m15(total) => "${total} उत्पाद";

  static String m16(date) => "मान्य तिल ${date}";

  static String m17(message) => "चेतावनी: ${message}";

  static String m18(length) => "हमें ${length} उत्पाद मिले";

  static String m19(week) => "सप्ताह ${week}";
