...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(message) => "Hiba: ${message}";

  static String m4(time) => "Lejárat ideje: ${time}";

  static String m5(hour) => "${hour} órája";
  ...
  static String m7(size) => "Maximális fájlméret: ${size} MB";

  static String m8(minute) => "${minute} perce";

  static String m9(itemCount) => "${itemCount} termékek";

  static String m10(price) => "Opciók összesen: ${price}";

  static String m11(percent) => "${percent} % Kedvezmény";

  static String m12(second) => "${second} másodperce";
  ...
  static String m15(total) => "${total} termék";

  static String m16(date) => "Érvényes: ${date}";

  static String m17(message) => "Figyelmeztetés: ${message}";

  static String m18(length) => "Találtunk ${length} terméket";

  static String m19(week) => " ${week}hét";
