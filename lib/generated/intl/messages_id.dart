...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(message) => "Galat: ${message}";

  static String m4(time) => "Kedaluwarsa dalam ${time}";
  ...
  static String m7(size) => "Ukuran file maksimum: ${size} MB";

  static String m8(minute) => "${minute} minutes ago";

  static String m9(itemCount) => "${itemCount} items";

  static String m10(price) => "Total opsi: ${price}";

  static String m11(percent) => "Jual ${percent} %";
  ...
  static String m15(total) => "${total} produk";

  static String m16(date) => "Berlaku sampai ${date}";

  static String m17(message) => "Warning: ${message}";

  static String m18(length) => "Kami menemukan produk ${length}";

  static String m19(week) => "Minggu ${week}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "bookingHistory":
            MessageLookupByLibrary.simpleMessage("Sejarah Pemesanan"),
        ...
        "confirmClearTheCart": MessageLookupByLibrary.simpleMessage(
            "Anda yakin ingin mengosongkan gerobak?"),
        ...
        "keep": MessageLookupByLibrary.simpleMessage("Menjaga"),
