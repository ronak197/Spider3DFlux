...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => " ${timeLeft}로 끝남";

  static String m3(message) => "오류 : ${message}";

  static String m4(time) => " ${time}후 만료";
  ...
  static String m7(size) => "최대 파일 크기 : ${size} MB";

  static String m8(minute) => "${minute} 분 전";

  static String m9(itemCount) => "${itemCount} 항목";

  static String m10(price) => "총 옵션 : ${price}";

  static String m11(percent) => "판매 ${percent} %";

  static String m12(second) => "${second} 초 전";

  static String m13(totalCartQuantity) => "장바구니, ${totalCartQuantity} 개 항목";

  static String m14(numberOfUnitsSold) => "판매 : ${numberOfUnitsSold}";

  static String m15(total) => "${total} 제품";

  static String m16(date) => " ${date}까지 유효";

  static String m17(message) => "경고 : ${message}";

  static String m18(length) => " ${length} 개의 제품을 찾았습니다.";

  static String m19(week) => "주 ${week}";
