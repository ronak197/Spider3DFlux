...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => "${timeLeft} تەواو دەبێت";

  static String m3(message) => "هەڵە: ${message}";

  static String m4(time) => "بەسەردەچێت لە ${time}";

  static String m5(hour) => "${hour} کاتژمێر پێش ئێستا";
  ...
  static String m8(minute) => "${minute} خولەك پێش ئێستا";

  static String m9(itemCount) => "${itemCount} ئایتم";

  static String m10(price) => "کۆى گشتى هەڵبژاردنەکان: ${price}";

  static String m11(percent) => "داشکاندن ${percent} %";

  static String m12(second) => "${second} چرکە پێش ئێستا";
  ...
  static String m15(total) => "${total} بەرهەمەکان";

  static String m16(date) => "گونجاوە تا ${date}";

  static String m17(message) => "ئاگاداری: ${message}";

  static String m18(length) => "${length} بەرهەم دۆزرایەوە";
