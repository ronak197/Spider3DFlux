...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => "Ends in ${timeLeft}";

  static String m3(message) => "ข้อผิดพลาด: ${message}";

  static String m4(time) => "จะหมดอายุใน ${time}";

  static String m5(hour) => "${hour} ชั่วโมงที่ผ่านมา";
  ...
  static String m7(size) => "ขนาดไฟล์สูงสุด: ${size} MB";

  static String m8(minute) => "{นาที} นาทีที่ผ่านมา";

  static String m9(itemCount) => "${itemCount} รายการ";

  static String m10(price) => "ตัวเลือกทั้งหมด: ${price}";

  static String m11(percent) => "ยอดขาย ${percent} %";

  static String m12(second) => "${second} วินาทีที่ผ่านมา";

  static String m13(totalCartQuantity) => "รถเข็นชอปปิ้งไอเท็ม ";

  static String m14(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m15(total) => "${total} ผลิตภัณฑ์";

  static String m16(date) => "ใช้ได้จนถึง ${date}";

  static String m17(message) => "คำเตือน: ${message}";

  static String m18(length) => "เราพบสินค้า ${length}";

  static String m19(week) => "สัปดาห์ ${week}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "active": MessageLookupByLibrary.simpleMessage("คล่องแคล่ว"),
        "addAName": MessageLookupByLibrary.simpleMessage("เพิ่มชื่อ"),
        "addASlug": MessageLookupByLibrary.simpleMessage("เพิ่มกระสุน"),
        ...
        "addingYourImage":
            MessageLookupByLibrary.simpleMessage("การเพิ่มรูปภาพของคุณ"),
        ...
        "agreeWithPrivacy":
            MessageLookupByLibrary.simpleMessage("เห็นด้วยกับความเป็นส่วนตัว"),
        ...
        "emptyUsername":
            MessageLookupByLibrary.simpleMessage("ชื่อผู้ใช้/อีเมลว่างเปล่า"),
        ...
        "goBackToAddress":
            MessageLookupByLibrary.simpleMessage("กลับไปที่แอดเดรส"),
        ...
        "myWishList":
            MessageLookupByLibrary.simpleMessage("รายการ Wishlist ของฉัน"),
        "nItems": m9,
        ...
        "orderSuccessTitle1":
            MessageLookupByLibrary.simpleMessage("คุณได้วางลำดับเรียบร้อยแล้ว"),
        "orderSuccessTitle2":
        ...
        "pleaseFillCode":
            MessageLookupByLibrary.simpleMessage("โปรดกรอกข้อมูลโค้ดของคุณ"),
        ...
        "private": MessageLookupByLibrary.simpleMessage("เอกชน"),
        ...
        "refundRequest":
            MessageLookupByLibrary.simpleMessage("คำขอเรียกคืนเงิน"),
        ...
        "reviewSent":
            MessageLookupByLibrary.simpleMessage("ส่งบทวิจารณ์ของคุณแล้ว!"),
        ...
        "shopSlug": MessageLookupByLibrary.simpleMessage("ร้านบุ้ง"),
        "shoppingCartItems": m13,
        "shortDescription":
            MessageLookupByLibrary.simpleMessage("คำอธิบายสั้น"),
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("แสดง Ordered ทั้งหมดของฉัน"),
