...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(time) => " ${time}içinde süresi doluyor";

  static String m5(hour) => "${hour} Saat önce";
  ...
  static String m7(size) => "Maksimum dosya boyutu: ${size} MB";

  static String m8(minute) => "${minute} Dakika önce";

  static String m9(itemCount) => "${itemCount} ürün";

  static String m10(price) => "Toplam seçenek: ${price}";

  static String m11(percent) => "% ${percent} İndirim ";

  static String m12(second) => "${second} Saniye önce";

  static String m13(totalCartQuantity) => "${totalCartQuantity} ürün, Sepette";

  static String m14(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m15(total) => "${total} ürün";

  static String m16(date) => " ${date}tarihine kadar geçerlidir";

  static String m17(message) => "Hata: ${message}";

  static String m18(length) => " \$${length} Ürün Bulundu";

  static String m19(week) => " ${week}haftası";
