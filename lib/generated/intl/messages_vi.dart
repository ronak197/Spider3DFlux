...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => "Kết thúc sau ${timeLeft}";

  static String m3(message) => "Lỗi: ${message}";

  static String m4(time) => "Hết hạn sau ${time}";
  ...
  static String m7(size) => "Kích thước tệp tối đa: ${size} MB";

  static String m8(minute) => "${minute} minutes ago";

  static String m9(itemCount) => "${itemCount} items";

  static String m10(price) => "Tổng số tùy chọn: ${price}";
  ...
  static String m14(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m15(total) => "${total} sản phẩm";

  static String m16(date) => "Có hiệu lực cho đến ${date}";

  static String m17(message) => "Warning: ${message}";

  static String m18(length) => "Chúng tôi tìm thấy ${length} sản phẩm";

  static String m19(week) => "Tuần ${week}";
