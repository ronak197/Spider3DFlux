...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(timeLeft) => "以 ${timeLeft}结尾";

  static String m3(message) => "Error: ${message}";

  static String m4(time) => "在 ${time}期满";
  ...
  static String m7(size) => "档案大小上限： ${size} MB";

  static String m8(minute) => "${minute} minutes ago";

  static String m9(itemCount) => "${itemCount} items";

  static String m10(price) => "选项总数： ${price}";

  static String m11(percent) => "出售${percent}%";

  static String m12(second) => "${second} seconds ago";

  static String m13(totalCartQuantity) =>
      "Shopping cart, ${totalCartQuantity} items";

  static String m14(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m15(total) => "${total} 个产品";

  static String m16(date) => "有效期至 ${date}";

  static String m17(message) => "Warning: ${message}";

  static String m18(length) => "我們找到 ${length} 個產品";

  static String m19(week) => "周 ${week}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "chooseYourPaymentMethod":
            MessageLookupByLibrary.simpleMessage("選擇你的支付方法"),
        ...
        "couponMsgSuccess":
            MessageLookupByLibrary.simpleMessage("恭喜你！優惠券代碼已成功應用"),
        ...
        "emptyCartSubtitle":
            MessageLookupByLibrary.simpleMessage("您似乎還沒有在包中添加任何物品。開始購物以填補它。"),
        "emptyUsername": MessageLookupByLibrary.simpleMessage("用戶名/電子郵件為空"),
        "emptyWishlistSubtitle":
            MessageLookupByLibrary.simpleMessage("輕按產品旁邊的任何一個即可收藏。我們將在這里為您保存！"),
        "endsIn": m2,
        ...
        "iwantToCreateAccount":
            MessageLookupByLibrary.simpleMessage("我想創建一個帳戶"),
        ...
        "orderSuccessMsg1": MessageLookupByLibrary.simpleMessage(
            "您可以使用我們的交貨狀態功能檢查訂單狀態。您將收到訂單確認電子郵件，其中包含您的訂單詳細信息以及跟踪其進度的鏈接。"),
        "orderSuccessMsg2": MessageLookupByLibrary.simpleMessage(
            "您可以使用之前定義的電子郵件和密碼登錄到您的帳戶。在您的帳戶上，您可以編輯個人資料數據，檢查交易歷史記錄，編輯對新聞通訊的訂閱。"),
