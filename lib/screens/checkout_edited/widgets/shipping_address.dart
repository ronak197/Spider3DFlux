...
class _ShippingAddressState extends State<ShippingAddress> {
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      // On the original mstore, only while click Next the data delivered
      // to the Shipping method, this way the Next button can be removed,
      // Which needed for my mission - make one payment page.
      onChanged: () => _onNext,
      key: _formKey,
      child: AutofillGroup(
